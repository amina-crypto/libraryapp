...
class CategorizationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorization" do
    assert_difference("Categorization.count") do
      post categorizations_url, params: { categorization: { category_id: @categorization.category_id, library_resource_id: @categorization.library_resource_id } }
    end
  ...
  test "should update categorization" do
    patch categorization_url(@categorization), params: { categorization: { category_id: @categorization.category_id, library_resource_id: @categorization.library_resource_id } }
