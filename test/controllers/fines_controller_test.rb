...
class FinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fine" do
    assert_difference("Fine.count") do
      post fines_url, params: { fine: { amount: @fine.amount, loan_id: @fine.loan_id, status: @fine.status } }
    end
  ...
  test "should update fine" do
    patch fine_url(@fine), params: { fine: { amount: @fine.amount, loan_id: @fine.loan_id, status: @fine.status } }
